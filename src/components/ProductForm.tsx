...
import { PlusCircle, PackagePlus, DollarSign, BarChart3 } from "lucide-react";
        ...
        >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-2">
                ...
                <div className="md:col-span-2 flex items-end">
                    <button
                        type="submit"
                        className="w-full bg-cyan-500 hover:bg-cyan-400 text-black font-black uppercase text-xs py-3 rounded-xl transition-all shadow-[0_0_20px_rgba(6,182,212,0.2)] active:scale-95 flex items-center justify-center gap-2"
                    >
